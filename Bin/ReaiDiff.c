...
int main(int argc, char* argv[]) {
    ...
    VecForeachPtr(&diff, line, {
        switch (line->type) {
            case DIFF_TYPE_SAM: same_count++; break;
            case DIFF_TYPE_ADD: add_count++; break;
            case DIFF_TYPE_REM: rem_count++; break;
            case DIFF_TYPE_MOD: mod_count++; break;
            case DIFF_TYPE_MOV: mov_count++; break;
        }
    });
